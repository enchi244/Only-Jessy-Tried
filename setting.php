                            ...
                            <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div clas="col" align="right">
                                        <button type="submit" name="edit_button" id="edit_button" class="btn btn-danger pink btn-sm"><i class="fas fa-edit"></i> Save</button>
                                        &nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control"name="restaurant_logo" id="restaurant_logo" />
                                            <br />
                                            <span class="text-muted" style="font-style:italic;">Only .jpg, .png file allowed for upload</span><br />
