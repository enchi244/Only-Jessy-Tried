...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2026 at 10:20 PM
...
--
-- Table structure for table `tbl_cms_about`
--

CREATE TABLE `tbl_cms_about` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_cms_carousel`
--

CREATE TABLE `tbl_cms_carousel` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_ext_files`
--

CREATE TABLE `tbl_ext_files` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_policy_files`
--

CREATE TABLE `tbl_policy_files` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_rde_views`
--

CREATE TABLE `tbl_rde_views` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_research_policy`
--

CREATE TABLE `tbl_research_policy` (
  `id` int(11) NOT NULL,
  `researcherID` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `abstract` text NOT NULL,
  `description` text NOT NULL,
  `research_conducted_id` int(11) DEFAULT NULL,
...
--
-- Indexes for table `tbl_cms_about`
--
ALTER TABLE `tbl_cms_about`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_cms_carousel`
--
ALTER TABLE `tbl_cms_carousel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_cms_news`
--
...
--
-- Indexes for table `tbl_ext_files`
--
ALTER TABLE `tbl_ext_files`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_policy_files`
--
ALTER TABLE `tbl_policy_files`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_rde_views`
--
ALTER TABLE `tbl_rde_views`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_trending` (`item_type`,`viewed_at`);
...
--
-- Indexes for table `tbl_research_policy`
--
ALTER TABLE `tbl_research_policy`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_cms_about`
--
ALTER TABLE `tbl_cms_about`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_cms_carousel`
--
ALTER TABLE `tbl_cms_carousel`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_cms_news`
--
ALTER TABLE `tbl_cms_news`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_ext_files`
--
ALTER TABLE `tbl_ext_files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_policy_files`
--
ALTER TABLE `tbl_policy_files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_rde_views`
--
ALTER TABLE `tbl_rde_views`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_research_policy`
--
ALTER TABLE `tbl_research_policy`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
