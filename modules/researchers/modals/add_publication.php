<div id="publicationModal" class="modal fade" data-backdrop="static" tabindex="-1" aria-labelledby="publicationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        ...
        <form method="post" id="publication_form" class="modal-content w-100" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-7 pr-lg-4">
                        ...
                        <div class="form-group mb-3">
                            <label for="abstract_pub"><i class="fas fa-align-left mr-2 text-primary"></i>Abstract</label>
                            <textarea name="abstract_pub" id="abstract_pub" class="form-control" rows="4" placeholder="Enter publication abstract..."></textarea>
                            <small class="text-muted mt-1 d-block text-right">
                                <i class="fas fa-pen mr-1"></i> Word Count: <span id="pub_word_count" class="font-weight-bold text-primary">0</span>
                            </small>
                        </div>
