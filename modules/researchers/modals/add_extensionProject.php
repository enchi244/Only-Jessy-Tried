                    ...
                    <div class="row">
                        <div class="col-lg-6 pr-lg-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title_extp" id="title_extp" class="form-control" placeholder="Enter project title" required />
                            </div>
                            ...
                            <div class="form-group mb-3 pb-3">
                                ...
                                <input type="text" name="target_beneficiaries_communities" id="target_beneficiaries_communities" class="form-control" placeholder="E.g. Local Farmers, Students" required />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 border-left pl-lg-4">
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="date" name="start_date_extc" id="start_date_extc" class="form-control" required />
                                </div>

                                <div class="col-md-6 form-group mb-3">
                                    <label for="completion_date_extc"><i class="far fa-calendar-check mr-2 text-primary"></i>Completion Date</label>
                                    <input type="date" name="completion_date_extc" id="completion_date_extc" class="form-control" required />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" name="funding_source_exct" id="funding_source_exct" class="form-control" placeholder="E.g. CHED, DOST" required />
                                </div>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="approved_budget_exct" id="approved_budget_exct" class="form-control border-left-0 pl-1" placeholder="0.00" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" name="partners" id="partners" class="form-control" placeholder="Enter project partners" required />
                                </div>
