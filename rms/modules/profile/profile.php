...
?>
    ...
    background-color: #e32747;
                    ...
                    <form method="post" id="profile_form" enctype="multipart/form-data">
                        <div class="row"><div class="col-md-12"><span id="message"></span><div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div clas="col" align="right">
                                        ...
                                        <button type="submit" name="edit_button" id="edit_button" class="btn btn-danger pink btn-sm"><i class="fas fa-edit"></i> &nbsp Update</button>
                                        &nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
