                        ...
                        <div class="card-header py-3">
                        	<div class="row">
                            	...
                            	<div class="col" align="right">
                            		<button type="button" name="add_user" id="add_user" class="btn btn-danger pink btn-sm"><i class="fas fa-plus"> Add User</i></button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
    	...
    	<form method="post" id="user_form" enctype="multipart/form-data">
            ...
            <div class="modal-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <option value="">Select Type</option>
                                    <option value="Waiter">Researcher</option>
                                    <option value="Cashier">Statistician</option>
        		...
        		<div class="modal-footer">
          			...
          			<input type="submit" name="submit" id="submit_button" class="btn btn-danger pink" value="Add" />
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
                ...
                $('#user_uploaded_image').html('<img src="'+data.user_profile+'"  style="border-radius: 50%;vertical-align: middle;" width="100" height="100"/><input type="hidden" name="hidden_user_image" value="'+data.user_profile+'" />');
