...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			{
				$delete_button = '<button type="button" name="delete_button"  style="margin-left: 5px;" title="Disable User" data-toggle="tooltip" class="btn btn-danger btn-sm delete_button" data-id="'.$row["user_id"].'" data-status="'.$row["user_status"].'"><i class="far fa-trash-alt"></i></button>';
				$status = '<button type="button" name="status_button" class="btn btn-success btn-sm">Enable</button>';
			}
			else
			{
				$delete_button = '<button type="button" name="delete_button"  style="margin-left: 5px;" title="Enable User" data-toggle="tooltip" class="btn btn-success btn-sm delete_button" data-id="'.$row["user_id"].'" data-status="'.$row["user_status"].'"><i class="fas fa-check"></i></button>';
			...
			<button type="button" name="edit_button" title="Update User" style="margin-left: 5px; margin-bottom: 5px; margin-top:5px;" data-toggle="tooltip" class="btn btn-primary btn-sm edit_button" data-id="'.$row["user_id"].'"><i class="fas fa-pencil-alt"></i></button>
